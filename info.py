...
API_ID = int(environ.get('API_ID', '8147825'))
API_HASH = environ.get('API_HASH', '74739bfc378fd8eb9cf48b8aa4cbdc4b')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://ibb.co/MkK06m9z')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6104712887').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002254656438'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001901697058').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001846945525') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1001846945525')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001939808332')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AKHILESHMB:AKHILESHMB@cluster0.zxtr26g.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Killikampetti')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Kilukampeti_Community')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Killikampetti') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MalayaliCoder')
